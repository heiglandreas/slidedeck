...
<span class="credit">[Day and Night world-map](https://www.timeanddate.com/worldclock/sunearth.html?day=09&month=06&year=2018&hour=13&min=45&sec=0&n=16&ntxt=Amsterdam&earth=0)</span>
...
```php
(new DateTimeZone('Europe/Amsterdam'))->getTransitions();
/*
  [143] => Array
      (
          [ts] => 1540688400
